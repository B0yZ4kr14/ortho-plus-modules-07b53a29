...
**Problema:** Todo o módulo ainda usa localStorage ao invés de PostgreSQL  
**Impacto:** Muito Alto - Sem persistência servidor, sem multi-device/multi-user  

### ⚠️ CRÍTICO 2: Criação de Pacientes Retorna Mock
**Arquivo:** `src/modules/pacientes/hooks/usePatients.ts`  
