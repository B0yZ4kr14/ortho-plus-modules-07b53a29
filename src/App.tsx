...
const RecallPage = lazy(
  () => import("./modules/marketing-auto/ui/pages/Recall"),
);
const TemplatesProcedimentosPage = lazy(
  () => import("./modules/procedimentos/ui/pages/TemplatesProcedimentos"),
);
...
const IARadiografia = lazy(
  () => import("@/modules/ia-radiografia/ui/pages/IARadiografia"),
);
const UserBehaviorAnalytics = lazy(
  () => import("@/modules/bi/ui/pages/UserBehaviorAnalytics"),
);
const OnboardingAnalytics = lazy(
  () => import("./modules/settings/ui/pages/OnboardingAnalytics"),
);
const ModulesAdmin = lazy(
  () => import("./modules/settings/ui/pages/ModulesAdmin"),
);
const ModulesSimple = lazy(
  () => import("./modules/settings/ui/pages/ModulesSimple"),
);
const ProfileSettings = lazy(
  () => import("./modules/settings/ui/pages/ProfileSettings"),
);
const CRM = lazy(() => import("./modules/crm/ui/pages/crm"));
const Teleodontologia = lazy(
  () => import("./modules/teleodonto/ui/pages/teleodonto"),
);
const EstoqueInventarioHistorico = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueInventarioHistorico"),
);
const EstoqueInventarioDashboard = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueInventarioDashboard"),
);
const ReportTemplates = lazy(
  () => import("@/modules/bi/ui/pages/ReportTemplates"),
);
...
const ScheduledBackupsManagement = lazy(
  () => import("./modules/settings/ui/pages/ScheduledBackupsManagement"),
);
const BackupExecutivePage = lazy(
  () => import("./modules/settings/ui/pages/BackupExecutivePage"),
);
...
// V4.0 - New Pages
const PatientDetailV2 = lazy(
  () => import("./modules/pacientes/ui/pages/PatientDetail-v2"),
);
const FluxoDigital = lazy(() => import("./modules/pep/ui/pages/FluxoDigital"));
const DashboardComercialROI = lazy(
  () => import("./modules/dashboards/ui/pages/DashboardComercial"),
);
const EstoqueAnaliseConsumo = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueAnaliseConsumo"),
);
const EstoqueIntegracoes = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueIntegracoes"),
);
const EstoqueAnalisePedidos = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueAnalisePedidos"),
);
const EstoqueScannerMobile = lazy(
  () => import("@/modules/estoque/ui/pages/EstoqueScannerMobile"),
);
const ContasReceber = lazy(
  () => import("@/modules/financeiro/ui/pages/ContasReceber"),
);
const ContasPagar = lazy(
  () => import("@/modules/financeiro/ui/pages/ContasPagar"),
);
const NotasFiscais = lazy(
  () => import("@/modules/financeiro/ui/pages/NotasFiscais"),
);
const Transacoes = lazy(
  () => import("@/modules/financeiro/ui/pages/Transacoes"),
);
const CryptoPagamentos = lazy(
  () => import("@/modules/financeiro/ui/pages/CryptoPagamentos"),
);
const ConciliacaoBancaria = lazy(
  () => import("@/modules/financeiro/ui/pages/ConciliacaoBancaria"),
);
const DashboardVendasPDV = lazy(
  () => import("./modules/financeiro/ui/pages/DashboardVendasPDV"),
);
const CRMFunil = lazy(() => import("@/modules/crm/ui/pages/CRMFunil"));
const RadiografiaPage = lazy(
  () => import("@/modules/ia-radiografia/ui/pages/radiografia"),
);
const CryptoPaymentPage = lazy(
  () => import("@/modules/crypto/ui/pages/CryptoPaymentPage"),
);
const SplitPagamentoPage = lazy(
  () => import("@/modules/split-pagamento/ui/pages/split-pagamento"),
);
const InadimplenciaPage = lazy(
  () => import("@/modules/cobranca/ui/pages/inadimplencia"),
);
const BIDashboardPage = lazy(
  () => import("@/modules/bi/ui/pages/bi-dashboard"),
);
const TISSPage = lazy(() => import("@/modules/tiss/ui/pages/tiss"));
const AssinaturaICP = lazy(
  () => import("@/modules/pep/ui/pages/AssinaturaICP"),
);
const ProgramaFidelidade = lazy(
  () => import("@/modules/marketing-auto/ui/pages/ProgramaFidelidade"),
);
const PDVPage = lazy(() => import("@/modules/pdv/ui/pages/PDVPage"));
const RelatorioCaixa = lazy(
  () => import("@/modules/financeiro/ui/pages/RelatorioCaixa"),
);
const MetasGamificacao = lazy(
  () => import("./modules/pdv/ui/pages/MetasGamificacao"),
);
...
const DashboardExecutivoPDV = lazy(
  () => import("./modules/pdv/ui/pages/DashboardExecutivoPDV"),
);
            ...
            <ModulesProvider>
              ...
              <Routes>
                ...
                <Route
                  path="/dentistas"
                  element={
                    <ProtectedRoute moduleKey="DENTISTAS">
                      <AppLayout>
                        <DentistasPage />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                <Route
                  path="/procedimentos"
                  element={
                    <ProtectedRoute moduleKey="PROCEDIMENTOS">
                      <AppLayout>
                        <ProcedimentosPage />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/financeiro/dashboard-vendas"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <DashboardVendasPDV />
                ...
                <Route
                  path="/cobranca"
                  element={
                    <ProtectedRoute moduleKey="INADIMPLENCIA">
                      <AppLayout>
                        <CobrancaPage />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/estoque/analise-pedidos"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <Suspense fallback={<LoadingState size="lg" />}>
                          <EstoqueAnalisePedidos />
                        </Suspense>
                      </AppLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/estoque/analise-consumo"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <Suspense fallback={<LoadingState size="lg" />}>
                          <EstoqueAnaliseConsumo />
                        </Suspense>
                      </AppLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/estoque/scanner-mobile"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <Suspense fallback={<LoadingState size="lg" />}>
                          <EstoqueScannerMobile />
                        </Suspense>
                      </AppLayout>
                    </ProtectedRoute>
                  }
                ...
                />
                <Route
                  path="/estoque/inventario/dashboard"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <Suspense
                ...
                <Route
                  path="/fidelidade"
                  element={
                    <ProtectedRoute moduleKey="FIDELIDADE">
                      <AppLayout>
                        <FidelidadePage />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute moduleKey="INVENTARIO">
                      <AppLayout>
                        <InventarioDashboard />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                <Route
                  ...
                  element={
                    <ProtectedRoute moduleKey="PORTAL_PACIENTE">
                      <AppLayout>
                        <PortalPacientePage />
                      </AppLayout>
                    </ProtectedRoute>
                ...
                />
                <Route
                  path="/configuracoes/backups-agendados"
                  element={
                    <ProtectedRoute requireAdmin>
                      <AppLayout>
                        <ScheduledBackupsManagement />
                      </AppLayout>
                    </ProtectedRoute>
                  }
                />
                <Route
                  path="/configuracoes/backup-executivo"
                  element={
                    <ProtectedRoute requireAdmin>
                      <AppLayout>
                        <BackupExecutivePage />
                ...
                />
                <Route
                  path="/templates-procedimentos"
                  element={
                    <ProtectedRoute>
                      <AppLayout>
                        <Suspense fallback={<LoadingState />}>
                          <TemplatesProcedimentosPage />
                        </Suspense>
                      </AppLayout>
                    </ProtectedRoute>
                  }
