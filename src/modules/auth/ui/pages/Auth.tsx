...
export default function Auth() {
  ...
  const handleLogin = async (values: LoginFormValues) => { console.log("HANDLE LOGIN STARTED");
    setIsLoading(true);
    console.log("CALLING SIGNIN"); const { error } = await signIn(values.email, values.password); console.log("SIGNIN RETURNED:", error);
    setIsLoading(false);

    if (!error) { console.log("NAVIGATING TO ROOT");
      navigate('/');
    }
  };
